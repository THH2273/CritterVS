package cielo.crittervs.forge.main.Entity.Model;// Made with Blockbench 5.0.7
...
public class BeamEntityModel<T extends MedBeamProjectile> extends EntityModel<T> {
	...
	public BeamEntityModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main = partdefinition.addOrReplaceChild("main", CubeListBuilder.create().texOffs(-2, 0).addBox(-2.0F, -11.0F, -14.0F, 4.0F, 4.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
